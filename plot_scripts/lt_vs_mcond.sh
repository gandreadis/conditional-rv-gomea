...
#python rvgomea/plots/gecco/plot_bisection_reb_rotation_matrices.py gecco-data/reb-chain-bisection-lt-vs-mcond lt-fb-online-pruned,mp-hg-fb_no_order-without_clique_seeding-conditional,mp-hg-fb_no_order-with_clique_seeding-conditional,full "(a) FB-LT,(b) FB-MCond-HG,(c) FB-MCond-HG-CS,(d) Full"
