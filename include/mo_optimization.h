...
void installedProblemEvaluation(int index, individual *ind, int number_of_touched_parameters,
                                int *touched_parameters_indices, double *parameters_before,
                                double *objective_values_before, double constraint_value_before);

void installedProblemEvaluationWithoutRotation(int index, individual *ind, double *parameters,
                                               double *objective_value_result, double *constraint_value_result,
...
void evaluateAdditionalFunctionsPartial(individual *ind, int number_of_touched_parameters, double *touched_parameters,
                                        double *parameters_before);

void ZDT1FunctionProblemEvaluation(double *parameters, double *objective_value_result, double *constraint_value_result,
                                   int objective_index);

void ZDT1FunctionPartialProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
                                          double *constraint_value_result, int objective_index);

void ZDT1FunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT1FunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT1FunctionPartialProblemEvaluationObjective1(individual *ind, double *parameters, double *objective_value_result,
                                                    double *constraint_value_result);
...
void ZDT2FunctionProblemEvaluation(double *parameters, double *objective_value_result, double *constraint_value_result,
                                   int objective_index);

void ZDT2FunctionPartialProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
                                          double *constraint_value_result, int objective_index);

void ZDT2FunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT2FunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT2FunctionPartialProblemEvaluationObjective1(individual *ind, double *parameters, double *objective_value_result,
                                                    double *constraint_value_result);
...
void ZDT3FunctionProblemEvaluation(double *parameters, double *objective_value_result, double *constraint_value_result,
                                   int objective_index);

void ZDT3FunctionPartialProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
                                          double *constraint_value_result, int objective_index);

void ZDT3FunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT3FunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT3FunctionPartialProblemEvaluationObjective1(individual *ind, double *parameters, double *objective_value_result,
                                                    double *constraint_value_result);
...
void ZDT4FunctionProblemEvaluation(double *parameters, double *objective_value_result, double *constraint_value_result,
                                   int objective_index);

void ZDT4FunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT4FunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);
...
void ZDT6FunctionProblemEvaluation(double *parameters, double *objective_value_result, double *constraint_value_result,
                                   int objective_index);

void ZDT6FunctionPartialProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
                                          double *constraint_value_result, int objective_index);

void ZDT6FunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT6FunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                             double *constraint_value_result);

void ZDT6FunctionPartialProblemEvaluationObjective1(individual *ind, double *parameters, double *objective_value_result,
                                                    double *constraint_value_result);
...
void BD1FunctionProblemEvaluation(double *parameters, double *objective_value_result, double *constraint_value_result,
                                  int objective_index);

void BD1FunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                            double *constraint_value_result);

void BD1FunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                            double *constraint_value_result);
...
void
BD2ScaledFunctionProblemEvaluation(double *parameters, double *objective_value_result, double *constraint_value_result,
                                   int objective_index);

void BD2ScaledFunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                                  double *constraint_value_result);

void BD2ScaledFunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                                  double *constraint_value_result);
...
void BD2ScaledFunctionPartialProblemEvaluation(individual *ind, int number_of_touched_parameters,
                                               int *touched_parameters_indices, double *parameters_before,
                                               double *objective_values_before, double constraint_value_before,
                                               int objective_index);

void BD2ScaledFunctionPartialProblemEvaluationObjective0(individual *ind, int number_of_touched_parameters,
                                                         int *touched_parameters_indices, double *parameters_before,
                                                         double *objective_values_before,
                                                         double constraint_value_before);

void BD2ScaledFunctionPartialProblemEvaluationObjective1(individual *ind, int number_of_touched_parameters,
                                                         int *touched_parameters_indices, double *parameters_before,
                                                         double *objective_values_before,
                                                         double constraint_value_before);

void
BD1FunctionPartialProblemEvaluation(individual *ind, int number_of_touched_parameters, int *touched_parameters_indices,
                                    double *parameters_before, double *objective_values_before,
                                    double constraint_value_before, int objective_index);

void BD1FunctionPartialProblemEvaluationObjective1(individual *ind, int number_of_touched_parameters,
                                                   int *touched_parameters_indices, double *parameters_before,
                                                   double *objective_values_before, double constraint_value_before);
...
void genMEDConvex2DFunctionProblemEvaluation(double *parameters, double *objective_value_result,
                                             double *constraint_value_result, int objective_index);

void genMEDConvex2DFunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                                       double *constraint_value_result);

void genMEDConvex2DFunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                                       double *constraint_value_result);
...
void genMEDConcave2DFunctionProblemEvaluation(double *parameters, double *objective_value_result,
                                              double *constraint_value_result, int objective_index);

void genMEDConvex2DFunctionPartialProblemEvaluation(individual *ind, int number_of_touched_parameters,
                                                    int *touched_parameters_indices, double *parameters_before,
                                                    double *objective_values_before, double constraint_value_before,
                                                    int objective_index);

void genMEDConcave2DFunctionProblemEvaluationObjective0(double *parameters, double *objective_value_result,
                                                        double *constraint_value_result);

void genMEDConcave2DFunctionProblemEvaluationObjective1(double *parameters, double *objective_value_result,
                                                        double *constraint_value_result);
...
void sumOfEllipsoidsFunctionProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
                                              double *constraint_value_result, int objective_index);

void
sumOfEllipsoidsFunctionProblemEvaluationObjective0(individual *ind, double *parameters, double *objective_value_result,
                                                   double *constraint_value_result);

void
sumOfEllipsoidsFunctionProblemEvaluationObjective1(individual *ind, double *parameters, double *objective_value_result,
                                                   double *constraint_value_result);

void sumOfEllipsoidsFunctionPartialProblemEvaluationObjective1(individual *ind, double *parameters,
...
void PFVisFunctionProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
                                    double *constraint_value_result, int objective_index);

void PFVisFunctionPartialProblemEvaluation(individual *ind, int number_of_touched_parameters,
                                           int *touched_parameters_indices, double *parameters_before,
                                           double *objective_values_before, double constraint_value_before,
                                           int objective_index);
...
short constraintParetoDominates(double *objective_values_x, double constraint_value_x, double *objective_values_y,
...
double computeDPFSMetric(double **default_front, int default_front_size, individual **approximation_front,
                         int approximation_front_size, short *to_be_removed_solution);
...
char *installedProblemName(int index) {
    switch (index) {
        ...
        case 10:
            return ((char *) "Pareto Front Visualization (fix_max)");
        case 11:
            return ((char *) "Pareto Front Visualization (fix_min)");
        case 101:
            return ((char *) "BT - Tumor Coverage - Least Organ Sparing");
        case 102:
            return ((char *) "BT - Tumor Coverage - Organ Sparing");
        case 103:
            return ((char *) "BT - Tumor Coverage - Minimum Safe Organ");
        case 104:
            return ((char *) "BT - Tumor Coverage - Minimum Safe Organ - with Multiplier");
        case 105:
            return ((char *) "BT - Tumor Coverage - Least Safe Index");
        case 106:
            return ((char *) "BT - Tumor Coverage - Least Safe Index");
    }
...
double installedProblemLowerRangeBound(int index, int dimension) {
    switch (index) {
        ...
        case 10:
            return (PFVisFunctionLowerRangeBound(dimension));
        case 11:
            return (PFVisFunctionLowerRangeBound(dimension));
        case 101:
            return (dwellTimeLowerBound(dimension));
        case 102:
            return (dwellTimeLowerBound(dimension));
        case 103:
            return (dwellTimeLowerBound(dimension));
...
double installedProblemUpperRangeBound(int index, int dimension) {
    switch (index) {
        ...
        case 10:
            return (PFVisFunctionUpperRangeBound(dimension));
        case 11:
            return (PFVisFunctionUpperRangeBound(dimension));
        case 101:
            return (dwellTimeUpperBound(dimension));
        case 102:
            return (dwellTimeUpperBound(dimension));
        case 103:
            return (dwellTimeUpperBound(dimension));
...
void installedProblemEvaluation(int index, individual *ind, int number_of_touched_parameters,
    ...
    if (index > 100) {
        if (touched_parameters_indices != NULL && !black_box_evaluations) {
            if (index == 105)
                BT_TumorCoverage_LeastSafeIndex_PartialProblemEvaluation(ind->dose_distribution_buffer, ind->parameters,
                                                                         parameters_before,
                                                                         number_of_touched_parameters,
                                                                         touched_parameters_indices,
                                                                         number_of_generations[current_population_index],
                                                                         ind->objective_values,
                                                                         &(ind->constraint_value),
                                                                         smoothening_volume,
                                                                         lower_bound_of_coverage,
                                                                         relaxation_factor_of_safety_indices);
            else if (index == 106)
                BT_LeastCoverageIndex_LeastSafeIndex_PartialProblemEvaluation(ind->dose_distribution_buffer,
                                                                              ind->parameters, parameters_before,
                                                                              number_of_touched_parameters,
                                                                              touched_parameters_indices,
                                                                              ind->objective_values,
                                                                              &(ind->constraint_value),
            ...
            if (index == 102)
                BT_TumorCoverage_OrganSparing_ProblemEvaluation(ind->parameters,
                                                                number_of_generations[current_population_index],
                                                                ind->objective_values, &(ind->constraint_value),
                                                                smoothening_volume);
            else if (index == 101)
                BT_TumorCoverage_LeastOrganSparing_ProblemEvaluation(ind->parameters,
                                                                     number_of_generations[current_population_index],
                                                                     ind->objective_values, &(ind->constraint_value),
                                                                     smoothening_volume);
            else if (index == 103)
                BT_TumorCoverage_MaximizeMinimumSafeOrgan_ProblemEvaluation(ind->parameters,
                                                                            number_of_generations[current_population_index],
                                                                            ind->objective_values,
                                                                            &(ind->constraint_value),
                                                                            smoothening_volume);
            else if (index == 104)
                BT_TumorCoverage_MaximizeMinimumSafeOrgan_ProblemEvaluation_with_Multiplier(ind->parameters,
                                                                                            number_of_generations[current_population_index],
                                                                                            ind->objective_values,
                                                                                            &(ind->constraint_value),
                                                                                            smoothening_volume);
                ...
                BT_TumorCoverage_LeastSafeIndex_ProblemEvaluation(ind->dose_distribution_buffer, ind->parameters,
                                                                  number_of_generations[current_population_index],
                                                                  ind->objective_values, &(ind->constraint_value),
                                                                  smoothening_volume, lower_bound_of_coverage,
                                                                  relaxation_factor_of_safety_indices);
            else if (index == 106)
        ...
        if (rotation_angle == 0.0) {
            if (touched_parameters_indices == NULL || black_box_evaluations)
                installedProblemEvaluationWithoutRotation(index, ind, ind->parameters, &(ind->objective_values[i]),
                                                          &(ind->constraint_value), number_of_parameters, NULL, NULL,
                                                          NULL, 0, i);
            else
            ...
            if (touched_parameters_indices == NULL || black_box_evaluations ||
                ...
                installedProblemEvaluationWithoutRotation(index, ind, rotated_parameters, &(ind->objective_values[i]),
                                                          &(ind->constraint_value), number_of_parameters, NULL, NULL, 0,
                                                          0, i);
                free(rotated_parameters);
            } else {
                if (problem_index == 9 &&
                    (learn_linkage_tree || static_linkage_tree)) {
                    if (i == 0)
                        sumOfEllipsoidsFunctionProblemEvaluationObjective0(ind, ind->parameters,
                                                                           &(ind->objective_values[0]),
                                                                           &(ind->constraint_value));
                    else if (i == 1) {
                        if (touched_parameters_indices != NULL)
                            free(touched_parameters);
                        ...
                        for (k = 0; k < number_of_touched_parameters; k++) {
                            if (touched_parameters_indices[k] == 0) {
                                ...
                                sumOfEllipsoidsFunctionPartialProblemEvaluationObjective1(ind, touched_parameters, 1,
                                                                                          block_indices,
                                                                                          touched_parameters_before,
                                                                                          ind->objective_values[1],
                                                                                          ind->constraint_value);
                                ...
                                if (cur_block != prev_block) {
                                    ...
                                    while (k + c < number_of_touched_parameters &&
                                        ...
                                        touched_parameters_before[(touched_parameters_indices[k + c] - 1) %
                                                                  block_size] = parameters_before[k + c];
                                        c++;
                                    }

                                    rotated_parameters = matrixVectorMultiplication(rotation_matrix, touched_parameters,
                                                                                    block_size, block_size);
                                    rotated_parameters_before = matrixVectorMultiplication(rotation_matrix,
                                                                                           touched_parameters_before,
                                                                                           block_size, block_size);

                                    sumOfEllipsoidsFunctionPartialProblemEvaluationObjective1(ind, rotated_parameters,
                                                                                              block_size, block_indices,
                    ...
                    rotated_parameters = matrixVectorMultiplication(rotation_matrix, touched_parameters,
                                                                    number_of_touched_parameters,
                                                                    number_of_touched_parameters);
                    rotated_parameters_before = matrixVectorMultiplication(rotation_matrix, parameters_before,
                                                                           number_of_touched_parameters,
                                                                           number_of_touched_parameters);
                    installedProblemEvaluationWithoutRotation(index, ind, rotated_parameters,
                                                              &(ind->objective_values[i]), &(ind->constraint_value),
                                                              number_of_touched_parameters, touched_parameters_indices,
                                                              rotated_parameters_before, objective_values_before,
                                                              constraint_value_before, i);
                    free(rotated_parameters_before);
...
void installedProblemEvaluationWithoutRotation(int index, individual *ind, double *parameters,
    ...
    if (black_box_evaluations || touched_parameters_indices == NULL) {
        switch (index) {
            case 0:
                ZDT1FunctionProblemEvaluation(parameters, objective_value_result, constraint_value_result,
                                              objective_index);
                break;
            case 1:
                ZDT2FunctionProblemEvaluation(parameters, objective_value_result, constraint_value_result,
                                              objective_index);
                break;
            case 2:
                ZDT3FunctionProblemEvaluation(parameters, objective_value_result, constraint_value_result,
                                              objective_index);
                break;
            case 3:
                ZDT4FunctionProblemEvaluation(parameters, objective_value_result, constraint_value_result,
                                              objective_index);
                break;
            case 4:
                ZDT6FunctionProblemEvaluation(parameters, objective_value_result, constraint_value_result,
                                              objective_index);
                break;
            case 5:
                BD1FunctionProblemEvaluation(parameters, objective_value_result, constraint_value_result,
                                             objective_index);
                break;
            case 6:
            ...
            case 8:
                ...
                break;
            case 9:
                sumOfEllipsoidsFunctionProblemEvaluation(ind, parameters, objective_value_result,
                                                         constraint_value_result, objective_index);
                break;
            case 10:
                PFVisFunctionProblemEvaluation(ind, parameters, objective_value_result, constraint_value_result,
                                               objective_index);
                break;
            case 11:
                PFVisFunctionProblemEvaluation(ind, parameters, objective_value_result, constraint_value_result,
        ...
        switch (index) {
            ...
            case 6:
                ...
                break;
            case 7:
                genMEDConvex2DFunctionPartialProblemEvaluation(ind, number_of_touched_parameters,
                                                               touched_parameters_indices, parameters_before,
                                                               objective_values_before, constraint_value_before,
                                                               objective_index);
                break;
            case 8:
                genMEDConcave2DFunctionProblemEvaluation(parameters, objective_value_result, constraint_value_result,
            ...
            case 10:
                PFVisFunctionPartialProblemEvaluation(ind, number_of_touched_parameters, touched_parameters_indices,
                                                      parameters_before, objective_values_before,
                                                      constraint_value_before, objective_index);
                break;
            case 11:
...
void ZDT1FunctionPartialProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
    ...
    switch (objective_index) {
        case 0:
            ...
            break;
        case 1:
            ZDT1FunctionPartialProblemEvaluationObjective1(ind, parameters, objective_value_result,
...
void ZDT2FunctionPartialProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
    ...
    switch (objective_index) {
        case 0:
            ...
            break;
        case 1:
            ZDT2FunctionPartialProblemEvaluationObjective1(ind, parameters, objective_value_result,
                                                           constraint_value_result);
            break;
    }
}
...
void ZDT3FunctionPartialProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
    ...
    switch (objective_index) {
        case 0:
            ...
            break;
        case 1:
            ZDT3FunctionPartialProblemEvaluationObjective1(ind, parameters, objective_value_result,
                                                           constraint_value_result);
            break;
    }
}
...
void ZDT6FunctionPartialProblemEvaluation(individual *ind, double *parameters, double *objective_value_result,
    ...
    switch (objective_index) {
        case 0:
            ...
            break;
        case 1:
            ZDT6FunctionPartialProblemEvaluationObjective1(ind, parameters, objective_value_result,
                                                           constraint_value_result);
            break;
    }
}
...
BD1FunctionPartialProblemEvaluation(individual *ind, int number_of_touched_parameters, int *touched_parameters_indices,
    ...
    switch (objective_index) {
        case 0:
            BD1FunctionProblemEvaluationObjective0(ind->parameters, &(ind->objective_values[0]),
                                                   &(ind->constraint_value));
            break;
        case 1:
...
void BD2ScaledFunctionPartialProblemEvaluation(individual *ind, int number_of_touched_parameters,
    ...
    switch (objective_index) {
        case 0:
            BD2ScaledFunctionPartialProblemEvaluationObjective0(ind, number_of_touched_parameters,
                                                                touched_parameters_indices, parameters_before,
                                                                objective_values_before, constraint_value_before);
            break;
        case 1:
            BD2ScaledFunctionPartialProblemEvaluationObjective1(ind, number_of_touched_parameters,
                                                                touched_parameters_indices, parameters_before,
                                                                objective_values_before, constraint_value_before);
            break;
    }
...
void genMEDConvex2DFunctionProblemEvaluation(double *parameters, double *objective_value_result,
    ...
    switch (objective_index) {
        case 0:
            genMEDConvex2DFunctionProblemEvaluationObjective0(parameters, objective_value_result,
                                                              constraint_value_result);
            break;
        case 1:
            genMEDConvex2DFunctionProblemEvaluationObjective1(parameters, objective_value_result,
                                                              constraint_value_result);
            break;
    }
}
...
void genMEDConcave2DFunctionProblemEvaluation(double *parameters, double *objective_value_result,
    ...
    switch (objective_index) {
        case 0:
            genMEDConcave2DFunctionProblemEvaluationObjective0(parameters, objective_value_result,
                                                               constraint_value_result);
            break;
        case 1:
            genMEDConcave2DFunctionProblemEvaluationObjective1(parameters, objective_value_result,
                                                               constraint_value_result);
            break;
    }
}
...
void sumOfEllipsoidsFunctionPartialProblemEvaluationObjective1(individual *ind, double *parameters,
    ...
    if (number_of_touched_parameters > 1) {
        for (i = 0; i < number_of_touched_parameters; i++) {
            ...
            result -= (pow(10.0, 6.0 * (((double) (j)) / ((double) (block_size - 1)))) * parameters_before[i] *
                       parameters_before[i]);
            result += (pow(10.0, 6.0 * (((double) (j)) / ((double) (block_size - 1)))) * parameters[i] * parameters[i]);
...
double PFVisSpreadAllPairsObjective(individual *ind) {
    ...
    for (i = 0; i < number_of_parameters; i += 2)
        for (j = 0; j < i; j += 2)
            result += pow(fmax(1e-5, distanceEuclidean2D(ind->parameters[i], ind->parameters[i + 1], ind->parameters[j],
                                                         ind->parameters[j + 1])), -4.0);

    return (result);
}

double
PFVisSpreadAllPairsObjectivePartial(individual *ind, int number_of_touched_parameters, int *touched_parameters_indices,
                                    double *parameters_before, double objective_value_before,
                                    double constraint_value_before) {
    int i, j;
    double result;
    ...
    for (i = 0; i < number_of_touched_parameters; i += 2) {
        for (j = 0; j < number_of_parameters; j += 2) {
            ...
            result -= pow(fmax(1e-5,
                               distanceEuclidean2D(parameters_before[i], parameters_before[i + 1], ind->parameters[j],
                                                   ind->parameters[j + 1])), -4.0);
            result += pow(fmax(1e-5, distanceEuclidean2D(ind->parameters[touched_parameters_indices[i]],
                                                         ind->parameters[touched_parameters_indices[i] + 1],
                                                         ind->parameters[j], ind->parameters[j + 1])), -4.0);
        }
    }
...
double PFVisStressObjective(individual *ind) {
    ...
    for (i = 0; i < number_of_parameters; i += 2) {
        for (j = 0; j < i; j += 2) {
            ...
            dist_mapped = distanceEuclidean2D(ind->parameters[i], ind->parameters[i + 1], ind->parameters[j],
                                              ind->parameters[j + 1]);
    ...
    for (i = 0; i < number_of_parameters; i += 2) {
        for (j = 0; j < pfvis_dimensions; j++) {
            ...
            dist_mapped = distanceEuclidean2D(ind->parameters[i], ind->parameters[i + 1], pfvis_triangle_x[j],
                                              pfvis_triangle_y[j]);
...
double PFVisStressObjectivePartial(individual *ind, int number_of_touched_parameters, int *touched_parameters_indices,
                                   double *parameters_before, double objective_value_before,
                                   double constraint_value_before) {
    int i, j;
    double dist, dist_mapped, norm, result;
    ...
    for (i = 0; i < number_of_touched_parameters; i += 2) {
        for (j = 0; j < number_of_parameters; j += 2) {
            if (j == touched_parameters_indices[i]) continue;
            norm = 1.0 / pfvis_dimensions;
            dist = distanceEuclidean(pfvis_normalized_front[touched_parameters_indices[i] / 2],
                                     pfvis_normalized_front[j / 2], pfvis_dimensions);
            norm = 2.0 / (pfvis_front_size - 1.0);

            dist_mapped = distanceEuclidean2D(parameters_before[i], parameters_before[i + 1], ind->parameters[j],
                                              ind->parameters[j + 1]);
            result -= norm * pow(dist - dist_mapped, 2.0);

            dist_mapped = distanceEuclidean2D(ind->parameters[touched_parameters_indices[i]],
                                              ind->parameters[touched_parameters_indices[i] + 1], ind->parameters[j],
                                              ind->parameters[j + 1]);
            result += norm * pow(dist - dist_mapped, 2.0);
        }
        for (j = 0; j < pfvis_dimensions; j++) {
            ...
            dist_mapped = distanceEuclidean2D(parameters_before[i], parameters_before[i + 1], pfvis_triangle_x[j],
                                              pfvis_triangle_y[j]);
            result -= norm * pow(dist - dist_mapped, 2.0);

            dist_mapped = distanceEuclidean2D(ind->parameters[touched_parameters_indices[i]],
                                              ind->parameters[touched_parameters_indices[i] + 1], pfvis_triangle_x[j],
                                              pfvis_triangle_y[j]);
            result += norm * pow(dist - dist_mapped, 2.0);
        }
    }
...
double PFVisCheckConstraintsPartial(individual *ind, double *polygon_x, double *polygon_y, int dimensions,
                                    int number_of_touched_parameters, int *touched_parameters_indices,
                                    double *parameters_before, double objective_value_before,
                                    double constraint_value_before) {
    int i, cons;
    ...
    for (i = 0; i < number_of_touched_parameters; i += 2) {
        if (!pointInPolygon(parameters_before[i], parameters_before[i + 1], polygon_x, polygon_y, dimensions))
            cons--;
        if (!pointInPolygon(ind->parameters[touched_parameters_indices[i]],
                            ind->parameters[touched_parameters_indices[i] + 1], polygon_x, polygon_y, dimensions))
            cons++;
    }
...
void
PFVisFunctionProblemEvaluation(individual *ind, double *parameters, double *objective_value, double *constraint_value,
                               int objective_index) {
...
void PFVisFunctionPartialProblemEvaluation(individual *ind, int number_of_touched_parameters,
    ...
    if (FOS_element_size != 2) {
        printf("Invalid FOS. Use flag -f 2 or -b.\n");
        exit(0);
    }

    if (objective_index == 0) {
        ind->constraint_value = PFVisCheckConstraintsPartial(ind, pfvis_triangle_x, pfvis_triangle_y, pfvis_dimensions,
                                                             number_of_touched_parameters, touched_parameters_indices,
                                                             parameters_before,
                                                             objective_values_before[objective_index],
                                                             constraint_value_before);

        ind->objective_values[0] = PFVisSpreadAllPairsObjectivePartial(ind, number_of_touched_parameters,
                                                                       touched_parameters_indices, parameters_before,
                                                                       objective_values_before[0],
                                                                       constraint_value_before);
    } else if (objective_index == 1) {
        ind->objective_values[1] = PFVisStressObjectivePartial(ind, number_of_touched_parameters,
                                                               touched_parameters_indices, parameters_before,
                                                               objective_values_before[1], constraint_value_before);
    }
}
...
void initializePFVisProblem(void) {
    ...
    for (i = 0; i < pfvis_dimensions; i++) {
        obj_min = pfvis_input_front[0][i];
        obj_max = pfvis_input_front[0][i];
        pfvis_minima_indices[i] = 0;
        pfvis_maxima_indices[i] = 0;
    ...
    for (i = 0; i < pfvis_front_size; i++) {
        for (j = 0; j < pfvis_dimensions; j++) {
            pfvis_normalized_front[i][j] = (pfvis_input_front[i][j] - pfvis_input_front[pfvis_minima_indices[j]][j]) /
                                           (pfvis_input_front[pfvis_maxima_indices[j]][j] -
                                            pfvis_input_front[pfvis_minima_indices[j]][j]);
    ...
    pfvis_triangle_x[0] = 0.0;
    pfvis_triangle_x[1] = 1.0;
    pfvis_triangle_x[2] = 0.5;
    pfvis_triangle_y[0] = 0.0;
    pfvis_triangle_y[1] = 0.0;
    pfvis_triangle_y[2] = 0.5 * sqrt(3);
...
void writeGenerationalStatisticsForOnePopulationWithDPFSMetric(int population_index) {
    ...
    sprintf(string, "  [ %4d %6d %10d ]  %11ld  %d\n", population_index, number_of_generations[population_index],
            population_sizes[population_index], real_number_of_evaluations, set_of_dose_calc_points_size);
    fputs(string, file);
...
*/
        if (problem_index > 100) {
            if (problem_index == 102)
                ...
                full_BT_TumorCoverage_MaximizeMinimumSafeOrgan_ProblemEvaluation(approximation_set[i]->parameters, obj,
                                                                                 &con);
            else if (problem_index == 104)
                full_BT_TumorCoverage_MaximizeMinimumSafeOrgan_ProblemEvaluation_with_Multiplier(
                        approximation_set[i]->parameters, obj, &con);
            else if (problem_index == 105)
                full_BT_TumorCoverage_LeastSafeIndex_ProblemEvaluation(approximation_set[i]->parameters, obj, &con, 0.9,
                                                                       2.0);
            else if (problem_index == 106)
                full_BT_LeastCoverageIndex_LeastSafeIndex_ProblemEvaluation(approximation_set[i]->parameters, obj, &con,
                                                                            full_dv_indices);
            ...
            for (i = 0; i < number_of_mixing_components[pop]; i++) {
                ...
                for (j = 0; j < cluster_sizes[pop]; j++) {
                    for (k = 0; k < number_of_objectives; k++) {
                        sprintf(string, "%13e ",
                                selection[pop][selection_indices_of_cluster_members[pop][i][j]]->objective_values[k]);
                        fputs(string, file);
                    }
...
void writePFVisPoints(individual **objective_elitist, int n, short is_elitist) {
    ...
    selected_obj =
            (objective_elitist[order[0]]->objective_values[1] + objective_elitist[order[n - 1]]->objective_values[1]) /
            2.0;
    selected_index = 0;
...
void computeApproximationSet(void) {
    ...
    *rank0_contribution, tot_rank0_size;
    ...
    population_rank0_and_elitist_archive = (double **) Malloc(
            population_rank0_and_elitist_archive_size * sizeof(double *));
    population_rank0_and_elitist_archive_objective_values = (double **) Malloc(
            population_rank0_and_elitist_archive_size * sizeof(double *));
    population_rank0_and_elitist_archive_constraint_values = (double *) Malloc(
            population_rank0_and_elitist_archive_size * sizeof(double));
    population_rank0_and_elitist_archive_dv_indices = (double **) Malloc(
            population_rank0_and_elitist_archive_size * sizeof(double *));
    ...
    for (i = 0; i < population_rank0_and_elitist_archive_size; i++) {
        ...
        population_rank0_and_elitist_archive_objective_values[i] = (double *) Malloc(
                number_of_objectives * sizeof(double));
    ...
    for (i = 0; i < population_rank0_and_elitist_archive_size; i++) {
        ...
        for (j = 0; j < population_rank0_and_elitist_archive_size; j++) {
            if (i != j) {
                ...
                if (same_objectives && (population_rank0_and_elitist_archive_constraint_values[i] ==
                                        population_rank0_and_elitist_archive_constraint_values[j]) && (i > j)) {
                    dominated = 1;
                    //
    ...
    for (i = 0; i < default_front_size; i++) {
        ...
        for (j = 0; j < approximation_front_size; j++) {
            if (approximation_front[j]->constraint_value == 0 && to_be_removed_solution[j] == 0) {
                distance = distanceEuclidean(default_front[i], approximation_front[j]->objective_values,
